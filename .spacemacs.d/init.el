  ...
  (setq-default
   ...
   '(
     ...
     (c-c++ :variables c-c++-default-mode-for-headers 'c++-mode
            ...
            ccls-executable (file-truename "ccls")
            ;; c-c++-lsp-args '("-v=1" "--log-file=/tmp/cc.log")
            ...
            c-c++-lsp-initialization-options '(:clang (:pathMappings '())
                                               :index (:multiVersionBlacklist '("^/usr/include")
                                                       :initialWhiteList '())))
     org
     (shell :variables
...
It should only modify the values of Spacemacs settings."
  ...
  (setq-default
   ...
   ;; (default "%I@%S")
   dotspacemacs-frame-title-format "%S:%b - %I"
